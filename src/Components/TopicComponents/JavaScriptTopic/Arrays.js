  ...
  render() {
    return (
      <TopicCard params={{title: 'Arrays'}}>
        {/* Arrays */}
        {renderHTML(`<h2>Arrays</h2>
          <p><strong>JavaScript array</strong> is an object that represents a collection of elements and each element specified by an index.&nbsp;</p>
        ...
        <div className="text-center jsc-topic-image"><img src={arrayImg} /></div>
      </TopicCard>
    );
  }
}
