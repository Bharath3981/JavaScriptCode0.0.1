(function($) {
    return $.fn.beautifyJSON = function(options) {
    	var defaults = {
    		type: "strict",
    		hoverable: true,
    		collapsible: true,
    	...
    	this.each( function() {
    		if(settings.type === "plain") {
				...
				if(settings.collapsible) {
					let collapser = "<span class='ellipsis'></span><div class='collapser'></div><ul class='array collapsible'>";
				} else {
					let collapser = "<div></div><ul class='array'>";
				}
				if(settings.hoverable) {
					let hoverabler = "<div class='hoverable'>";
				} else {
					let hoverabler = "<div>"
				}
				text += "<div id='json'>";
